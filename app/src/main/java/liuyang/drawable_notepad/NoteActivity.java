...
public class NoteActivity extends AppCompatActivity {
    ...
    private static final int RESULT_CODE_STARTAUDIO=222;
    ...
    private AlertDialog alertDialogDeletNote;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup AlertDialog
        alertDialogDeletNote=initAlertDialogDeletNote();
    ...
    /**
     * Method used for first setup of delet button AlertDialog
     */
    private AlertDialog initAlertDialogDeletNote(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(this.getString(R.string.confirmation)).setTitle(getString(R.string.delet_note));
     ...
     */
    public void shareNote(@Nullable MenuItem menuItem){
        Intent textIntent = new Intent(Intent.ACTION_SEND);
        textIntent.setType("text/plain");
        textIntent.putExtra(Intent.EXTRA_TEXT, editText.getText().toString());
        startActivity(Intent.createChooser(textIntent, "分享"));
    }


    /*
    methon to delet the note which is being writed
    */
    public void deletnote(@Nullable MenuItem menuItem){
        alertDialogDeletNote.show();
    }
